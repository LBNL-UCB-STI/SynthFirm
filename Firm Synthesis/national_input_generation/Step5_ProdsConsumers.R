...
firms_all = data.table::fread("./outputs_national/synthetic_firms.csv", h = T)
sup_df = data.table::fread("./outputs_national/synthetic_producers.csv", h = T)
buyer_df = data.table::fread("./outputs_national/synthetic_consumers.csv", h = T)
sctg_lookup = data.table::fread("./inputs_national/SCTG_Groups_revised.csv", h = T)
...
for (i in 1:5) {
  ...
  fwrite(g1_prods, paste0("./outputs_national/prods_sctg", i, ".csv"))
  fwrite(g1_consm, paste0("./outputs_national/consumers_sctg", i, ".csv"))
  gc()
}
