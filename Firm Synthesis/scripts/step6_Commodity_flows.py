...
producer = read_csv("outputs/synthetic_producers_V3.csv", low_memory = False)
        ...
        for faf in list_of_faf:
            ...
            for level in available_levels:
                ...
                paired_buyer_supplier.loc[:,'Utility'] = \
                    -0.000566 * paired_buyer_supplier.loc[:,'Distance'] + \
                        -1.11e-06 * paired_buyer_supplier.loc[:,'Value']
