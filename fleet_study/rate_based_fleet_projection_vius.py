...
ax.set(ylim=(0, 0.2))
plt.savefig(os.path.join(path_to_plot, 'plot_forecast', 'com_age_distribution_vius_baseline.png'), dpi = 300,
            bbox_inches = 'tight')
plt.show()
...
# running the mandate version --> not used in current study
# fleet_mix_current_year = fleet_mix_baseyear[['sourceTypeID', 'population_by_year', 'yearID', 
#                                              'ageID', 'ageFraction', 'sourceTypePopulation']]
