...
plt.ylim([1, 2.5])
plt.savefig(os.path.join(path_to_plot, 'plot_forecast', 'LDV_growth_factor_moves_baseline.png'), dpi = 300,
            bbox_inches = 'tight')
plt.show()
...
plt.legend(fontsize = 12)
plt.ylim([1, 2])
plt.savefig(os.path.join(path_to_plot, 'plot_forecast', 'com_growth_factor_moves_baseline.png'), dpi = 300,
            bbox_inches = 'tight')
plt.show()
