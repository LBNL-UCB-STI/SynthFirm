...
def firm_fleet_generator_post_mc(fleet_year, fleet_name, regulations, synthetic_firms_with_location_file,
...
# private_fuel_mix_file = os.path.join(parameter_dir, 'fleet/private_fuel_mix_scenario.csv')
    ...
    col_var = ['CBPZONE', 'FAFZONE', 'esizecat', 'Industry_NAICS6_Make',
           'Commodity_SCTG', 'Emp', 'BusID', 'MESOZONE', 'lat', 'lon',
           'state_abbr', 'Production']
    if need_regional_calibration:
        col_var.extend(regional_variable)
    firms_with_adj = firms_with_adj[col_var] # 'ZIPCODE', 
    ...
    idx_var = ['CBPZONE', 'FAFZONE', 'esizecat', 'Industry_NAICS6_Make',
           'Commodity_SCTG', 'Emp', 'BusID', 'MESOZONE', 'lat', 'lon',
           'state_abbr', 'simulated_capacity'] # 'ZIPCODE', 
    if need_regional_calibration:
    ...
    idx_var = ['CBPZONE', 'FAFZONE', 'esizecat', 'Industry_NAICS6_Make',
           'Commodity_SCTG', 'Emp', 'BusID', 'MESOZONE', 'lat', 'lon',
          'state_abbr', 'fleet_id', 'EV_powertrain (if any)', 'veh_capacity'] # 'ZIPCODE', 
