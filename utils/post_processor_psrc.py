...
def psrc_bus_location_calibration(cleaned_parcel_file, mzemp_file,
                                  synthetic_firms_with_location_file,
                                  plot_dir, psrc_crs = 'EPSG:2285'):
    # region_name = 'Seattle'
    ...
    '''
    print('Start calibrating business locations within PSRC region!')
    ...
    psrc_parcels = pd.read_csv(cleaned_parcel_file, sep = ',')
    ...
    synthetic_firm_to_calibrate = read_csv(synthetic_firms_with_location_file, sep = ',')
    ...
    print('PSRC county FIPs for business location calibration:')
    print(CT_in_PSRC)
    ...
    print(f'RMSE of CBG-level employment: {rmse_emp}, R^2 of CBG-level employment: {r2_emp}')
    ...
    synthetic_firm_output.to_csv(synthetic_firms_with_location_file, index = False)
