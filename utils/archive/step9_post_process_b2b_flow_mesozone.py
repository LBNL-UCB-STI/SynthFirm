...
combined_modeled_OD_agg = combined_modeled_OD.groupby(['SellerZone', "orig_FAFID", "orig_FAFNAME", 'BuyerZone', 
...
# <codecell>
combined_modeled_OD_agg.to_csv(c.output_dir + 'processed_b2b_flow_summary_mesozone.csv', sep = ',')