...
# define scatter plot
def validate_firm_employment(synthetic_firms_with_location_file, 
                             spatial_boundary_file,
                             mesozone_to_faf_file, domestic_summary_zone_file, 
                             lehd_file, us_county_map_file, plot_dir,  
                             region_code = None, focus_region = None, 
                             port_analysis = False, 
                             international_summary_zone_file = None,
    ...
    # us_county_map_file = os.path.join(param_dir, 'US_counties.geojson') # add this to config
    # domestic_summary_zone_file = os.path.join(output_dir, 
    #                                           'domestic_b2b_flow_summary_mesozone.csv')
    print('Starting firm employment validation...')
    ...
    # print(region_map_with_firm.head(5))
