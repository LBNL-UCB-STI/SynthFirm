...
study_area_faf <- c(251, 259, 331, 441) # boston ones
...
combined_counties = sf::st_read("RawData/combined_county_2018.geojson")
states = sf::st_read("RawData/tl_2017_us_state/tl_2017_us_state.shp")
