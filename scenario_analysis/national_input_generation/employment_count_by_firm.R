...
employment_by_firm_size = data.table::fread("BayArea_GIS/us_state_naics_detailedsizes_2016.txt", h = T)
...
write.csv(employment_by_size_group_filtered, 'national_GIS/employment_by_firm_size_naics.csv')
...
write.csv(employment_by_size_group_no_naics, 'national_GIS/employment_by_firm_size_gapfill.csv')
