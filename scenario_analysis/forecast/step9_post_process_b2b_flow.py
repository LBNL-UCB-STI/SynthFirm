...
truck_mode = ['For-hire Truck Fuel', 'Private Truck Elec', 
              'Private Truck Fuel', 'For-hire Truck Elec']
...
for sc_dir in scenario_dirs:
    ...
    for sctg in c.list_of_sctg_group:
        print(sctg)
        b2b_dir = c.output_dir + sc_dir + '/' + sctg
    ...
    #         print(modeled_OD_by_sctg.head(5))
            ...
            result_dir = c.output_dir + sc_dir + '/' + sctg + '_truck'
            isExist = os.path.exists(result_dir)
            if not isExist:
           # Create a new directory because it does not exist
               os.makedirs(result_dir)
            truck_output.to_csv(result_dir + '/truck_only_OD_' + sctg + '_' + 
    ...
    # <codecell>
    combined_modeled_OD_agg.to_csv(c.output_dir + sc_dir + '/processed_b2b_flow_summary.csv', sep = ',')